...
public class ClubsAdapter extends RecyclerView.Adapter<ClubsAdapter.ViewHolder> {
    ...
    public ClubsAdapter(Context context,ArrayList<AndroidVersion> android) {
        this.android = android;
        this.context = context;
    }

    @Override
    public ClubsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_grid_club, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ClubsAdapter.ViewHolder viewHolder, int i) {
